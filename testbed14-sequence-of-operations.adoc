...
Alice's sister composed the Multi Sensor NDVI Stacker processing chains. The chain performs 3 collections  and wants to deploy the workflow. These steps are illustrated on the diagram below.
